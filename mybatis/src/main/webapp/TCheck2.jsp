...
<section id="main" class="p-relative" role="main">
    ...
    <aside id="sidebar">
        ...
        <ul class="list-unstyled side-menu">
            ...
            <li>
                <a class="sa-side-form" href="${pageContext.request.contextPath}/app/TAdd">
                    <span class="menu-item">Add Student</span>
                </a>
            </li>
            <li>
                <a class="sa-side-typography" href="${pageContext.request.contextPath}/app/TDelete">
                    <span class="menu-item">Delete Student</span>
                </a>
            </li>
            <li>
                <a class="sa-side-widget" href="${pageContext.request.contextPath}/app/Search">
                    <span class="menu-item">Check List</span>
                </a>
            </li>
            <li class="active">
                <a class="sa-side-table" href="${pageContext.request.contextPath}/app/TADDHomework">
                    <span class="menu-item">Add Homework</span>
                </a>
            </li>
            <li class="active">
                <a class="sa-side-form" href="${pageContext.request.contextPath}/app/Check">
            ...
            <div class="table-responsive overflow">
                <table class="tile table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td><%=sh.getScore()%></td>
                        <td><a href="${pageContext.request.contextPath}/app/CheckHomework2?sId=<%=sh.getStudentId()%>&&hwId=<%=sh.getHomeworkId()%>&&hwTitle=<%=sh.getHomeworkTitle()%>&&hwContent=<%=sh.getHomeworkContent()%>"><input type="button" value="Check" class="btn btn-sm m-t-10"></a></td>
                ...
                <form action="${pageContext.request.contextPath}/app/Check" method=post >
