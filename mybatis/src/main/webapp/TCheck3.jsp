...
<section id="main" class="p-relative" role="main">
    ...
    <section id="content" class="container">
        <div class="block-area" id="basic">
            ...
            <form action="${pageContext.request.contextPath}/app/CheckHomework3" role="form">
            ...
            <form action="/TCheck2.jsp" method=post >
                <a href="${pageContext.request.contextPath}/app/CheckHomework?hwId=${pageContext.request.getParameter("hwId")}"><input type="button" value="Back" class="btn btn-sm m-t-10"></a>
            </form>
