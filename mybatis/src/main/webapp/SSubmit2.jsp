...
<section id="main" class="p-relative" role="main">
    ...
    <section id="content" class="container">
        <div class="block-area" id="basic">
            ...
            <form action="${pageContext.request.contextPath}/app/SubmitHomeworkServlet" role="form">
            ...
            <form action="/SSubmit.jsp" method=post >
                <a href="${pageContext.request.contextPath}/app/submit1?sId=${pageContext.request.getParameter("sId")}"><input type="button" value="Back" class="btn btn-sm m-t-10"></a>
            </form>
